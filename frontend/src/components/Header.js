        ...
        <div className='h-full container mx-auto flex items-center px-4 justify-between'>
            ...
            <div className='flex items-center gap-7'>
                ...
                <div>
                    {
                        user?._id ? (
                            <button onClick={handleLogout} className='px-3 py-1 rounded-full text-white hover:bg-red-800 bg-red-600'>LOGOUT</button>
                            
                        ) : (
                            <Link to={"/login"} className='px-3 py-1 rounded-full text-white hover:bg-red-800 bg-red-600'>LOGIN</Link>
